// <copyright file="SearchService.cs" company="Games For Seva">
...
namespace YICG.Apps.Teams.DigitalKnowBot.Services
{
    ...
    /// <summary>
    /// This class implements all of the method(s) defined in <see cref="ISearchService"/>.
    /// </summary>
    public class SearchService : ISearchService
    {
        ...
        // Default to 25 results, same as the page size of a messaging extension query.
        ...
        private async Task InitializeAsync(string storageConnectionString)
        {
            ...
            {
                this.telemetryClient.TrackTrace($"Failed to initialize Azure Search Service: {ex.Message}", SeverityLevel.Error);
