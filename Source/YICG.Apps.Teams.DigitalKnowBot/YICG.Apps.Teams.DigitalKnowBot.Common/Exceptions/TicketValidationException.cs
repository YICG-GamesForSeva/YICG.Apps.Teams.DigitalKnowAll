// <copyright file="TicketValidationException.cs" company="Games For Seva">
// Copyright (c) Games For Seva. All rights reserved.
// </copyright>

namespace YICG.Apps.Teams.DigitalKnowBot.Common.Exceptions
{
    using System;
    ...
    public class TicketValidationException : Exception
    {
        ...
        /// Initializes a new instance of the <see cref="TicketValidationException"/> class.
        /// </summary>
        /// <param name="message">The message to be captured.</param>
